...
from scenarios.module_split_n1 import *


OUTPUTS_DIR = join(dirname(__file__), "outputs/n1")
...
disc_funcs = [lifting_plane_design, propulsion, aircraft_aerodynamics, aircraft_mass,
              nominal_mission, handling_quality_analysis, climb_performances,
              low_speed_performances, co2_metric, economics, payload_range_analysis]
